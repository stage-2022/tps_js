require = function (r, e, n) {
    function t(n, o) {
        ...
        if (!e[n]) {
            ...
            i.resolve = f;
            var s = e[n] = new t.Module(n); r[n][0].call(s.exports, i, s, s.exports)
        }
        return e[n].exports
    }
    function o(r) {
        ...
        35: [function (require, module, exports) {
            ...
            var s = function () {
                function s(t) {
                    ...
                    if (i(this, s), this.element = t, this.options = Object.assign({}, {slidesToScroll:1,slidesVisible:1,loop:!1,pagination:!1,navigation:!0,infinite:!1},o),this.options.loop && this.options.infinite)
                    ...
                    this.options.infinite && (this.offset = this.options.slidesVisible + this.options.slidesToScroll, this.offset > r.length && console.error("Vous n'avez pas assez d'élément dans le carousel", t), 
                    this.items = [].concat(e(this.items.slice(this.items.length - this.offset).map(function (t) { return t.cloneNode(!0) })), e(this.items), e(this.items.slice(0, this.offset).map(function (t) { return t.cloneNode(!0) }))), 
                    this.gotoItem(this.offset, !1)),
                    this.items.forEach(function (t) { return n.container.appendChild(t) }), 
                    this.setStyle(), 
                    this.options.navigation && this.createNavigation(), 
                    this.options.pagination && this.createPagination(), 
                    this.moveCallbacks.forEach(function (t) { return t(n.currentItem) }), 
                    this.onWindowResize(), 
                    window.addEventListener("resize", this.onWindowResize.bind(this)), 
                    this.root.addEventListener("keyup", function (t) { "ArrowRight" === t.key || "Right" === t.key ? n.next() : "ArrowLeft" !== t.key && "Left" !== t.key || n.prev() }), 
                    this.options.infinite && this.container.addEventListener("transitionend", 
                    this.resetInfinite.bind(this))
                } 
                return t(s, [{ key: "setStyle", value: function () {
                    var t = this,
                ...
                { key: "createNavigation", value: function () {
                    ...
                    this.root.appendChild(e), this.root.appendChild(i), 
                ...
                { key: "createPagination", value: function () { 
                    ...
                    i = []; this.root.appendChild(e); 
                    for (var s = function (s) {
                         var n = t.createDivWithClass("carousel__pagination__button"); 
                         n.addEventListener("click", function () { return t.gotoItem(s + t.offset) }), 
                         e.appendChild(n), 
                         i.push(n) 
                        }, 
                        ...
                        this.onMove(function (e) {
                            var s = t.items.length - 2 * t.offset, n = i[Math.floor((e - t.offset) % s / t.options.slidesToScroll)];
                            n && (i.forEach(function (t) { return t.classList.remove("carousel__pagination__button--active") }), 
                             ...
                             var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                              if (t < 0) { 
                                if (!this.options.loop) return;
                                 ...
                                 var i = -100 * t / this.items.length; !1 === e && (this.container.style.transition = "none"), 
                                 this.container.style.transform = "translate3d(" + i + "%, 0, 0)",
                                 this.container.offsetHeight, 
                                 !1 === e && (this.container.style.transition = ""), 
                                 this.currentItem = t, 
                                 this.moveCallbacks.forEach(function (e) { return e(t) }) }
                         }, 
                        ...
                        { key: "onWindowResize", value: function () { 
                            ...
                            e !== this.isMobile && (this.isMobile = e, this.setStyle(), 
                            this.moveCallbacks.forEach(function (e) { return e(t.currentItem) }))
                         }
                         }, 
                     ...
                     { key: "slidesToScroll", get: function () { return this.isMobile ? 1 : this.options.slidesToScroll } }, 
                     { key: "slidesVisible", get: function () { return this.isMobile ? 1 : this.options.slidesVisible } }
                    ]), s}(),
                      n=function(){ 
                        new s(document.querySelector("#carousel0"), 
                        { slidesVisible: 3, slidesToScroll: 2, pagination: !0 }), 
                        new s(document.querySelector("#carousel1"), 
                        { slidesVisible: 3, slidesToScroll: 3, loop: !0, pagination: !0 }), 
                        new s(document.querySelector("#carousel2"), 
                        { slidesVisible: 3, slidesToScroll: 2, infinite: !0, pagination: !0 }), 
                        new s(document.querySelector("#carousel3"), 
                        { slidesVisible: 4, slidesToScroll: 2, infinite: !0, pagination: !1 }) 
                        }; 
